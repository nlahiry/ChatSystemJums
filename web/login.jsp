<%-- 
    Document   : login
    Created on : 3 Jul, 2017, 12:37:29 PM
    Author     : User
--%>
...
<html>
    ...
    <body>
        <div class="login-window">
            <form id="login" action="none">
                <h1 id="ff-proof" class="ribbon">JUMS &nbsp;&nbsp;</h1>
                <div class="apple">
    ...
    <style>
        ...
        /*        .apple{
                    background-image: url("<%=request.getContextPath()%>/Resources/Jadavpur_University_Logo.png");
                ...
                .apple {
                    ...
                    z-index: 100;
                    background-image: url("<%=request.getContextPath()%>/Resources/1281529315.gif");
